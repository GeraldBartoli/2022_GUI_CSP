...
trace_btn = tk.Button(frame, text="Check to run tracert", command=lambda:do_command("tracert"))
trace_btn.pack()

msave_btn = tk.Button(frame, text="Check to msave", command=lambda: mSave())
msave_btn.pack()
